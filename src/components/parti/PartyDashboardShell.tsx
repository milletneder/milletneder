...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: 'zayif-noktalar', label: 'Zayif Noktalar', icon: TrendingDown, comingSoon: true },
  { href: 'guclu-noktalar', label: 'Guclu Noktalar', icon: TrendingUp, comingSoon: true },
  { href: 'bolgesel', label: 'Bolgesel', icon: Compass, comingSoon: true },
  { href: 'swing', label: 'Swing Secmen', icon: Target, comingSoon: true },
  { href: 'agirliklandirma', label: 'Agirliklandirma', icon: Sliders },
  { href: 'projeksiyon', label: 'Projeksiyon', icon: BarChart3 },
  { href: 'uyarilar', label: 'Uyarilar', icon: Bell, comingSoon: true },
