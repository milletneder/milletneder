    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <div className="space-y-10 mt-10">
          {/* Genel */}
          <section>
            <h2 className="text-lg font-bold mb-3">1. Genel Hükümler</h2>
          ...
          {/* Hizmet Tanımı */}
          <section>
            <h2 className="text-lg font-bold mb-3">2. Hizmet Tanımı</h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          {/* Hesap ve Kayıt */}
          <section>
            <h2 className="text-lg font-bold mb-3">3. Hesap ve Kayıt</h2>
          ...
          {/* Oy Kullanma */}
          <section>
            <h2 className="text-lg font-bold mb-3">4. Oy Kullanma Kuralları</h2>
            <Card>
              <CardContent className="pt-5 space-y-4">
                <div>
                  <h3 className="text-sm font-semibold mb-1">Oy Hakkı</h3>
                ...
                <Separator />
                <div>
                  <h3 className="text-sm font-semibold mb-1">Oy Değiştirme</h3>
                  <p className="text-sm text-muted-foreground">
                ...
                <Separator />
                <div>
                  <h3 className="text-sm font-semibold mb-1">Oy Gizliliği</h3>
                  <p className="text-sm text-muted-foreground">
          ...
          {/* Yasaklar */}
          <section>
            <h2 className="text-lg font-bold mb-3">5. Yasaklanan Davranışlar</h2>
            <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
          ...
          <section>
            <h2 className="text-lg font-bold mb-3">6. Sorumluluk Sınırlaması</h2>
            <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
          ...
          {/* Fikri Mülkiyet */}
          <section>
            <h2 className="text-lg font-bold mb-3">7. Fikri Mülkiyet</h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          {/* Değişiklikler */}
          <section>
            <h2 className="text-lg font-bold mb-3">8. Koşullarda Değişiklik</h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          {/* İletişim */}
          <section>
            <h2 className="text-lg font-bold mb-3">9. İletişim</h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
